...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [['Rise', 'Pissed', 'Rebel']];
	var curDifficulty:Int = 1;

	public static var weekUnlocked:Array<Bool> = [true];

	var weekCharacters:Array<Dynamic> = [['cyril', 'bf', 'gf']];
	...
	override function create()
	{
		...
		var yellowBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, 0xFFFF99FF);
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			if (stopspamming == false)
			{
				...
				grpWeekCharacters.members[1].offset.set(50, -5);
